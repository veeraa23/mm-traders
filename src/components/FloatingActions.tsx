  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute left-full ml-3 bg-gray-900 text-white text-xs font-medium px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          Chat on WhatsApp
        </span>
      </a>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-6 z-50 w-12 h-12 bg-green-700 hover:bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-all duration-300",
